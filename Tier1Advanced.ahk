...
;;Dekalb IT redirect
::#dekalbit::{shit down}{tab 10}{shift up}{down}{tab}{down 2}{tab 2}{down}{tab}{down 7}{tab 2}{down}{tab 6}Dekalb IT{tab}Partner needs to work with their IT.{tab}Partner will call back and choose a different option to get their IT department.{end}
